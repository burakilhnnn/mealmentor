        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MealPlanId = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "text", nullable: false),
                    MealPlansId = table.Column<string>(type: "text", nullable: false),
                    MealName = table.Column<string>(type: "text", nullable: false),
                    Calories = table.Column<int>(type: "integer", nullable: false),
                    Protein = table.Column<int>(type: "integer", nullable: false),
                    Carbs = table.Column<int>(type: "integer", nullable: false),
                    Fats = table.Column<int>(type: "integer", nullable: false),
                    MealPlansId1 = table.Column<string>(type: "text", nullable: true),
                    MealPlansId2 = table.Column<string>(type: "text", nullable: true),
                    MealPlansId3 = table.Column<string>(type: "text", nullable: true),
                    MealPlansId4 = table.Column<string>(type: "text", nullable: true)
                },
                constraints: table =>
                {
